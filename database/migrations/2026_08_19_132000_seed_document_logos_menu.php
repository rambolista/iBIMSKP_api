...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::transaction(function () use ($now): void {
            ...
            DB::table('menus')->updateOrInsert(
                ['slug' => 'administration:document-logos'],
                [
                    'label' => 'Document Logos',
                    'url' => '/apps/administration/document-logos',
                    'icon' => 'photo',
            ...
            $menuId = DB::table('menus')->where('slug', 'administration:document-logos')->value('id');
            if (! $menuId) {
                return;
            }
            ...
            $sourceMenuId = DB::table('menus')->where('slug', 'barangay-services:document-templates')->value('id');
            ...
            foreach ($sourcePermissions as $permission) {
                DB::table('role_menu_permissions')->updateOrInsert(
                    ['role_id' => $permission->role_id, 'menu_id' => $administrationId],
                    [
                        'can_view' => true,
                        'can_add' => false,
                        'can_edit' => false,
